...
```
./deploy_operator.sh --management_namespace <management-namespace> --digest <just digest value without sha256> --version <version> --workload_namespace <workload-namespace> --pullPrefix cp.stg.icr.io/cp/cpd
```
